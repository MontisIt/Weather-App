...
def getWeather():
    try:
        ...
        #weather
        api="https://api.openweathermap.org/data/2.5/weather?q="+city+"&appid=ad7cd1831fa74578444c9f7cfa41047f"
...
#logo
Logo_iage=PhotoImage(file="Copy of logo.png")
